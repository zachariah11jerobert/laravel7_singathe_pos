                ...
                <div class="col-md-9">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <a href="#" style="fload: right" class="btn btn-dark" data-toggle=""
                        ...
                        <div class="card-body">
                            <table class="table table-bordered table-left">
                                ...
                                <tbody>
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                <a href="#" data-toggle="modal" 
                                                    data-target="#editproduct"><i class="fa fa-dit">
                                                    </i>Edit</a>
                                                <a href="#" data-toggle="modal" 
                                                    data-target="deleteproduct {{ $Product-> }} " class="btn btn-sm btn-danger"> <i class="fa fa-trash"></i>
                                                    Del</a>
                                            </div>
                                        </td>
                                    </tr>
                                    ...
                                    data-keyboard="false" tabindex="-1" aria-labelledby=""
                                    aria-hidden="trur">
                                            ...
                                            <div class="modal-body">
                                                <form action="{{ route('product.update', $user->id)}}" method="post">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="Password" name="Password" readonly value="{{ $user->password }}" id="" 
                                                            class="form-control">
                                                    </div>
                                                    <div class="form-group">
                                ...
                                <!-- Modl -->
                                <div class="modal right fade" id="deleteproduct{{ $Products->id }}" data-backdrop="static" 
                                        data-keyboard="false" tabindex="-1" aria-labelledby=""
                                        aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form action="{{ route('product.destroy', $user->id)}}" method="post">
                                                        @csrf
                                                        @method('delet')
                                                        <p>Are you user you want to delete this {{ Products->name }}</p>
                                                        <div class="modal-footer">
