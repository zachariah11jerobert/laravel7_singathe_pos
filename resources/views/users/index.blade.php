                            ...
                            <table class="table table-bordered table-left">
                                ...
                                <tbody>
                                    @foreach ($users as $key => $user)
                                        ...
                                        <div class="modal left fade" id="editUser{{ $user->id }} "
                                            data-backdrop="static" data-keyboard="" aria-labelledby="staticBackdoropLable"
                                            aria-hidden="true">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form action="{{ router('users.update') }}" method="post">
                                                            @csrf
                                                            @method('put')
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <select name="is_admin" id="" class="Form-control">
                                                                    ...
                                                                    <option value="2"
                                                                        @if ($user->is_admin == 1)  @endif>Cashire
                                                                    </option>
                                                                </select>
                                                            </div>
                                        ...
                                        <div class="modal left fade" id="editUser{{ $user->id }} "
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form action="{{ router('users.destroy', $user->id) }}"
                                                            method="post">
                                                            @csrf @method('delete')
                                                            <p>
